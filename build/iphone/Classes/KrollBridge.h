...
@interface TiOriginalTabObject : KrollCoverageObject {
#else
@interface TiOriginalTabObject : KrollObject {
#endif
@private
...
extern NSString * TiOriginalTab$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiOriginalTabObject *_tioriginaltab;
	BOOL shutdown;
