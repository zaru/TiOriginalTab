...
// in simulator we redefine to format for TiOriginalTab Developer console
...
{\
	NSString * exceptionName = [@"org.tioriginaltab." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tioriginaltab";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiOriginalTabNativeItemNone = -1, 
	UITiOriginalTabNativeItemSpinner = -2,
	UITiOriginalTabNativeItemProgressBar = -3,
	
	UITiOriginalTabNativeItemSlider = -4,
	UITiOriginalTabNativeItemSwitch = -5,
	UITiOriginalTabNativeItemMultiButton = -6,
	UITiOriginalTabNativeItemSegmented = -7,
	
	UITiOriginalTabNativeItemTextView = -8,
	UITiOriginalTabNativeItemTextField = -9,
	UITiOriginalTabNativeItemSearchBar = -10,
	
	UITiOriginalTabNativeItemPicker = -11,
	UITiOriginalTabNativeItemDatePicker = -12,
	
	UITiOriginalTabNativeItemInfoLight = -13,
	UITiOriginalTabNativeItemInfoDark = -14,
	
	UITiOriginalTabNativeItemDisclosure = -15,
	
	UITiOriginalTabNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all TiOriginalTab instances of
