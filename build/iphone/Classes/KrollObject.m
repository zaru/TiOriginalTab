 ...
 * Copyright (c) 2009-2011 by TiOriginalTab, Inc. All Rights Reserved.
...
//@interface TiOriginalTabObject : NSObject
//@end

@interface TiOriginalTabObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiOriginalTabObject class]])
		{
			for (NSString *key in [[(TiOriginalTabObject*)o modules] allKeys])
			{
